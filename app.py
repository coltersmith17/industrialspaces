...
def init_sample_data():
    ...
    background_image_url = copy_image('main photo behind.jpg', 'mainphotobehind.jpg')

    # Delete all existing properties to refresh the data
